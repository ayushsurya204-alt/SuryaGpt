  ...
  return (
    ...
    lg:px-8 py-12'>
      <h2 className='text-3xl font-semibold text-center mb-10 xl:mt-30 
       text-gray-300 dark:text-white'>Credit Plans</h2>
       <div className='flex flex-wrap jsutify-center gap-8'>
          {plans.map((plan)=>(
            <div key={plan._id} className={`border border-gray-200
            dark:border-purple-700 rounded-lg shadow hover:shadow-lg
            transistion-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ?
              "bg-purple-50 dark:bg-purple-900":"bg-white dark:bg-transparent" }`} >
                <div className='flex-1'>
                  ...
                  <ul className='lsit-disc list-inside text-sm text-gray-700
                ...
                transistion-colors cursor-pointer'>Buy Now</button>
              </div>
          ))}
       </div>
    </div>
